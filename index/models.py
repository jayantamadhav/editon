...
class Donator(models.Model):
	d_name 			= models.CharField(verbose_name='Donator name', max_length=300, null=True, blank=True)
	d_amt 			= models.CharField(verbose_name='Donater Amount(Only for record)', max_length=300, null=True, blank=True)
	d_picture 		= models.ImageField(verbose_name='Donator Photo', upload_to='Donator photo', blank=True, null=True)
